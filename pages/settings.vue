...
const handleGoogleBindSuccess = async (response: CredentialResponse) => {
  oauthStatus.isBindingGoogle = true;
  try {
    const { credential } = response;
    const res: any = await ($axios as any).post("/api/user/bind-google", { credential });
