...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Complete your account setup by setting a password.' },
...
<template>
  <div class="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex justify-center items-center p-4 animate-fade-in">
    <UNotifications />

    <div class="w-full max-w-md">
      <!-- Animated Background Shapes -->
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-green-200 to-emerald-200 rounded-full blur-3xl opacity-10 dark:opacity-5"></div>
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-teal-200 to-green-200 rounded-full blur-3xl opacity-10 dark:opacity-5"></div>
      </div>

      <!-- Main Card -->
      <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
        <!-- Gradient Header -->
        <div class="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 p-8 text-white text-center">
        ...
        <form @submit.prevent="handleSubmit" class="p-8">
          ...
          <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4 mb-6">
            <p class="text-sm text-green-700 dark:text-green-300">
              ✨ <strong>Optional but recommended:</strong> Set a password to add extra security to your account. You can skip this for now and set it later.
            </p>
          </div>
        ...
        <!-- Footer -->
        <div class="px-8 pb-8 text-center border-t border-gray-200 dark:border-gray-700">
          <p class="text-sm text-gray-600 dark:text-gray-400 mt-4">
            You can update this anytime in your 
            <NuxtLink to="/settings" class="font-bold text-green-600 dark:text-green-400 hover:text-emerald-600">
              account settings
            </NuxtLink>
          </p>
        </div>
