  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'Finance Tracker - Track your expenses and income with FTraker' },
        { name: 'theme-color', content: '#ffffff' },
        { name: 'apple-mobile-web-app-capable', content: 'yes' },
        { name: 'apple-mobile-web-app-status-bar-style', content: 'black-translucent' },
        { name: 'apple-mobile-web-app-title', content: 'FTraker' },
        { name: 'keywords', content: 'finance tracker, expense tracker, pengatur keuangan, aplikasi keuangan, budget, personal finance, money management, FTraker' },
